...
# echo "to see your published contracts."
 pact-broker publish pacts/GettingStartedOrderWeb-GettingStartedOrderApi.json  --consumer-app-version=1.0.0 --broker-base-url=https://syndigo.pactflow.io --broker-token=_gSy6TVWzc4icqNOXDOMhw